    ...
    >
      ...
      <header className="mb-10">
        <h1 className="text-4xl sm:text-5xl font-bold tracking-tight text-[#004c97]">
          Programa de Autoconhecimento Docente — UFSM
        </h1>
        <br />
        <p className="mt-4 max-w-4xl text-lg leading-relaxed">
          ...
          Utilizando <em>psicoeducação</em>, <em>escrita reflexiva</em> e <em>questionamento
          socrático</em>, ele promove equilíbrio entre vida acadêmica e pessoal, fomenta a saúde
          mental e favorece uma trajetória mais autêntica.
        </p>
        ...
        {[
          {
            ...
            desc:
              'Os formulários utilizam os Cinco Grandes Fatores da Personalidade: Abertura à Experiência, Conscienciosidade, Extroversão, Amabilidade e Neuroticismo.',
          },
          {
          ...
          },
          {
            ...
            desc:
              'O foco está em apoiar o professor na sala de aula, na pesquisa e na vida acadêmica, com impacto positivo no bem-estar.',
          },
        ].map((c) => (
          <article
            key={c.title}
